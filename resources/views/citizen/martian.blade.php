...
<div class="col-md-3 col-sm-5">
  ...
  <div class="profile-avatar">
    <img src="/assets/citizen/<?=$public_address?>/profile_pic.png" class="profile-avatar-img thumbnail" alt="Profile Image. Source <?=$user['data']->data->picture?>" style="max-height: 100px;">
  </div> <!-- /.profile-avatar -->
