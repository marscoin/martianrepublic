...
<div class="feed-subject">
    <h5 style="font-size: 30px; color: #999;"><a href="{{{$proposal->ipfs_hash}}}">Archived Proposal #{{ strtoupper(substr(str_replace("https://ipfs.marscoin.org/ipfs/", "", $proposal->ipfs_hash), 1, 8)) }}</a></h5>
...
<div class="feed-actions">
    ...
    <a href='/forum/t/{{ $proposal->discussion }}' class="pull-left discussion-link">
       Discussion for this proposal: <i class="fa fa-external-link"></i></a>
