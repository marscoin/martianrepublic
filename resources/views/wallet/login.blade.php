...
@endif
 ...
 <!-- 
	...
	<div class="col-sm-4">
      ...
      <form class="form account-form" method="POST" action="/wallet/loginattempt">
        ...
        <div class="form-group clearfix">
          ...
          <div class="pull-right">
            <small><a href="/wallet/forgot">Forgot Password?</a></small>
          </div>
        </div> <!-- /.form-group -->
      ...
      <a href="/wallet/signup" class="">Create an account!</a>
</div>
