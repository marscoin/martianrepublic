    ...
    <div class="account-body">
      ...
      <form class="form account-form" method="POST" action="/twofachallenge">
        ...
        <div class="form-group" style="text-align: center;">
          <input name="secret" id="secret" style="height: 68px; font-size: 42px; font-weight: 700;  text-align: center;" type="text" class="form-control" id="register-2fa" placeholder="Enter code" tabindex="1" autofocus >
          <button type="submit" class="btn btn-success btn-block btn-lg" tabindex="2">Complete 2FA challenge &nbsp; <i class="fa fa-refresh"></i>
          </button>
        </div> 
      </form>
