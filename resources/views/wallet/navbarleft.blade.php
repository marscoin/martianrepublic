          ...
          <!-- <li class="dropdown">
            ...
            <ul class="dropdown-menu noticebar-menu noticebar-hoverable" role="menu">
               ...
               <li>
                <a href="#" class="noticebar-item">
                  ...
                  <span class="noticebar-item-body">
                    <strong class="noticebar-item-title">Version 1.5.690 Released</strong>
                    <span class="noticebar-item-text">A new version of the online wallet went live. Enjoy!</span>
                    <span class="noticebar-item-time"><i class="fa fa-clock-o"></i> 2021-07-14</span>
                  </span>
                </a>
              </li>
              ...
              <li class="noticebar-menu-view-all">
                <a href="/wallet/features">View All Features/Milestones</a>
              </li>
            </ul>
          </li> -->
          <!-- <li class="dropdown">
