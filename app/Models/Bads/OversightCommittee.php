...
class OversightCommittee extends Model
{
    ...
    {
        return $this->hasMany(Deputy::class, 'committee_id');
    }

    /** @return HasManyThrough<Instrument> */
    public function instruments(): HasManyThrough
    {
        return $this->hasManyThrough(Instrument::class, Deputy::class, 'committee_id', 'certified_by_deputy_id');
    }
}
